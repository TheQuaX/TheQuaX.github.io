            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        promises = reqSpecs.map(function (reqSpec) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return [4 /*yield*/, (0, allSettled)(promises)];
                    case 1:
...
export default ResponseBasedRateLimiter;
